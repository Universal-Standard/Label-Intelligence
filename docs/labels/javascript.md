...
## Purpose
Classifies changes that modify JavaScript code paths.

## When to Use
- JS source changes in application/runtime
- Tooling or scripts implemented in JavaScript
- Refactors in JS modules
...
## Sample Scenario
A pull request is opened to address work matching **javascript** scope. During triage, maintainers confirm the intent aligns with this label and apply related labels for routing, risk, and size.
