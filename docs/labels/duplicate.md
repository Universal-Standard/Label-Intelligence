...
## Purpose
Flags issues or PRs that repeat an already tracked item.

## When to Use
- Same root cause already tracked elsewhere
- A previous PR/issue already implements requested scope

## When Not to Use
- Related-but-distinct problem statements
...
## Sample Scenario
A pull request is opened to address work matching **duplicate** scope. During triage, maintainers confirm the intent aligns with this label and apply related labels for routing, risk, and size.
