...
## Purpose
Marks items intentionally not planned for implementation.

## When to Use
- Request conflicts with product direction
- Cost/risk outweighs value
- Supported alternatives already exist

## When Not to Use
- Issues that are merely deferred
...
## Sample Scenario
A pull request is opened to address work matching **wontfix** scope. During triage, maintainers confirm the intent aligns with this label and apply related labels for routing, risk, and size.
